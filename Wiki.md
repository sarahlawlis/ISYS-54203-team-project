...
1.	store documents, notes, and information in attributes
2.	kick off workflows to achieve some sort of output
3.	track detailed history and performance of the project

**Reporting** - users will have the ability to create saved searches that can filter for:
